...
Public Class edit_students
    ...
    Protected Sub Button1_Click(sender As Object, e As EventArgs) Handles Button1.Click
        ...
        connect.Open()
        Dim command As New SqlCommand("Update Student set LastName = '" & lastname & "', FirstMidName = '" & firstmidname & "', EnrollmentDate = '" & enrollmentdate & "' where ID = '" & studenid & "'", connect)
        command.ExecuteNonQuery()
        MsgBox("Data siswa berhasil di ubah!", MsgBoxStyle.Information, "Message")
        connect.Close()
