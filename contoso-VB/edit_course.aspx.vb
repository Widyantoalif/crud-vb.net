...
Public Class edit_course
    ...
    Protected Sub Button1_Click(sender As Object, e As EventArgs) Handles Button1.Click
        ...
        connect.Open()
        Dim command As New SqlCommand("Update Course set Title = '" & title_course & "', Credits = '" & credits_course & "' where CourseID = '" & course_id & "'", connect)
        command.ExecuteNonQuery()
        MsgBox("Data course berhasil di ubah!", MsgBoxStyle.Information, "Message")
        connect.Close()
